    ...
    (() => {{
      ...
      function renderHistory(ticker, visibleRows) {{
        ...
        for(const e of events) {{
          ...
          let status='AUDIT ONLY',action='—',fillDate='—',fillPrice='—',exitDate='—',exitPrice='—',rulePL='—',noStop='—',stop='—',exitReason='—';
          let lifeRet=null;
          if(life) {{
