...
def run(provider, cfg: dict, root: str | Path, history_start: str | None = None, provider_name: str = 'unknown'):
    ...
    try:
        ...
        panel_cols = [c for c in [
            ...
            'ma20_slope_5','ma50_slope_20','ma100_slope_20','medium_trend_confirm',
            'atr20','atr_pct_20','atr_pct_median_120','atr_regime_ratio',
            ...
            'prior_high_10','prior_high_20','prior_low_10','prior_low_20',
            'residual_mom_60','residual_mom_120',
